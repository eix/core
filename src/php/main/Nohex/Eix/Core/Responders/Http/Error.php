...
class Error extends HttpResponder
{
    ...
    {
        return $this->buildResponse('\Nohex\Eix\Core\Responses\Http\Json');
    }

    protected function httpGetForXml()
    {
        return $this->buildResponse('\Nohex\Eix\Core\Responses\Http\Xml');
    }

    protected function httpGetForHtml()
    {
        $response = $this->buildResponse('\Nohex\Eix\Core\Responses\Http\Html');
